...
do
    ...
    case $key in
	    ...
	    echo "-a option is optional. Location of the directory where the app is downloaded"
            exit
            ;;
        -a)
	    LOCATION_OF_APP="$2"
	    LOCATION_OF_APP_PROVIDED=1
	    shift;
	    shift;
	    ;;
        *)
...
cd $INSTALL_PATH
if [ $LOCATION_OF_APP_PROVIDED -eq 0 ]
then
