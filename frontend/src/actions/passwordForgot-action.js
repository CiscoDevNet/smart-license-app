...
function forgotPassword(username, pswd_hint, newPassword) {
    return dispatch => {
        updatePassword(username, pswd_hint, newPassword)
        .then(
            user => {
...
function updatePassword(username, pswd_hint, newPassword) {
    const requestOptions = {
            ...
            body: JSON.stringify({ username, pswd_hint, newPassword })
    };
